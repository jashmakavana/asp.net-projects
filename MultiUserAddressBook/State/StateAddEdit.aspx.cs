...
public partial class MultiUserAddressBook_State_StateAddEdit : System.Web.UI.Page
{
    #region Load Event
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                lblMessage.Text = "<strong>State Add-Edit Page | Edit  Mode</strong> | StateID = " + Request.QueryString["StateID"].ToString();
                FillControls(Convert.ToInt32(Request.QueryString["StateID"]));
            }
            else
            {
                lblMessage.Text = "<h3>State Add-Edit Page | Add Mode</h3>";
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        SqlSingle strUserID =  SqlInt32.Null;
        ...
        try
        {
            ...
            if (Request.QueryString["StateID"] != null)
            {
                ...
                Response.Redirect("~/MultiUserAddressBook/State/StateList.aspx", true);
